...
public class ProgramSample {
    ...
    public ResponseEntity<String> callbackEvents(@RequestBody final String reqBody) {
        ...
        for (CallAutomationEventBase event : events) {
            ...
            if (event instanceof CallConnected) {
                ...
                startMediaStreamingOptions.setOperationCallbackUrl(
                        " https://d785-2409-40c2-4012-6347-2d46-8f6c-a036-8287.ngrok-free.app");
                startMediaStreamingOptions.setOperationContext("startMediaStreamingContext");
                // without options.
                // client.getCallConnection(callConnectionId)
                // .getCallMedia().startMediaStreaming();

                // With options.
                client.getCallConnection(callConnectionId)
                        .getCallMedia().startMediaStreamingWithResponse(startMediaStreamingOptions, Context.NONE);
                ...
                log.info("Media Streaming Failed");
                ...
                // without options.
                // client.getCallConnection(callConnectionId)
                // .getCallMedia().stopMediaStreaming();

                StopMediaStreamingOptions stopMediaStreamingOptions = new StopMediaStreamingOptions();
                stopMediaStreamingOptions
                        .setOperationCallbackUrl("https://d785-2409-40c2-4012-6347-2d46-8f6c-a036-8287.ngrok-free.app");

                // with options
                client.getCallConnection(callConnectionId)
                        .getCallMedia().stopMediaStreamingWithResponse(stopMediaStreamingOptions, Context.NONE);
    ...
    private String createOutboundCall() {
        try {
            ...
            MediaStreamingOptions streamingOptions = new MediaStreamingOptions(
                    "wss://145a-2409-40c2-4012-6347-2d46-8f6c-a036-8287.ngrok-free.app",
            ...
            createCallOptions = createCallOptions.setMediaStreamingConfiguration(streamingOptions);
            Response<CreateCallResult> result = client.createCallWithResponse(createCallOptions, Context.NONE);
            // result.getValue().getCallConnectionProperties().getMediaStreamingSubscription().getState();
            // log.info("Media subscription state:--> " +
            // result.getValue().getCallConnectionProperties()
            // .getMediaStreamingSubscription().getState().toString());
