...
public class EventDispatcher {
    ...
    EventDispatcher() {
        this.notificationCallbacks = new Hashtable<>();
    }

    /// <summary>
    /// Get instance of EventDispatcher
    /// </summary>
    ...
    private String buildEventKey(String eventType, String eventKey) {
    ...
    private CallingServerEventBase extractEvent(String content) {
        try {
    ...
    private String getEventKey(CallingServerEventBase callEventBase) {
