package com.communication.CallPlayAudio.Controllers;
...
@RestController
public class CallPlayAudioController {
	...
	public ResponseEntity<Object> loadFile(@PathVariable(value = "fileName", required = false) String fileName) {
		String filePath = "src/main/java/com/communication/CallPlayAudio/audio/" + fileName;
