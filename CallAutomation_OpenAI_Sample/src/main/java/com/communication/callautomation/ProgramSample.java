...
public class ProgramSample {
    ...
    public ResponseEntity<String> callbackEvents(@RequestBody final String reqBody,
        ...
        for (CallAutomationEventBase event : events) {
            ...
            if (event instanceof CallConnected) {
                ...
                callConnectionProperties(callConnectionId);
            }
    ...
    private void callConnectionProperties(final String callConnectionId) {
        client.getCallConnection(callConnectionId).getCallProperties().getAnsweredFor();
    }
